...
public class Cup extends Stackable {
    ...
    public Cup getInnerCup() { return innerCups.isEmpty() ? null : innerCups.get(innerCups.size() - 1); }

    /** Retorna la lista de inner cups de esta taza. */
    public ArrayList<Cup> getInnerCups() { return innerCups; }
    ...
    public boolean hasInnerCup() { return !innerCups.isEmpty(); }
